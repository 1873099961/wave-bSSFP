...
% pathname = 'D:\MRI（only modify codes）\CSandAI cine rawdata\2.bssfp gfactor\7.wave_T1T2_1209\CSbssfp_and_CSwave_rawdata\';
% file_Wave = [pathname, 'UID_52069527546300_bssfp360_wave10_CS_R4.raw'];
...
pathname = 'D:\MRI(only modify codes)\CSandAI cine rawdata\2.bssfp gfactor\13.2022331_zhu_CSwave\';
file_Wave = [pathname, 'UID_190792685918320_bssfpwave_T2CS4_amp0.raw'];
...
gfactor = squeeze(std(real(ress), 0, 4))/sqrt(Ry);
as(gfactor);
figure;
pcolor(gfactor(:,:,1));
shading interp;
